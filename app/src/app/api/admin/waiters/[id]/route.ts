/**
 * PATCH  /api/admin/waiters/[id] — update fields; omit `password` to keep current.
...
export async function PATCH(
  ...
  if (body.password) {
    patch.password_hash = await bcrypt.hash(body.password, HASH_ROUNDS);
  }
  ...
  // body.password is only present when the admin typed a new one — WaitersPanel
