/**
 * POST   /api/collection/auth — validate a collection-staff password, issue a session cookie.
 ...
 *
 * Reads from the collection_staff table; passwords are bcrypt-hashed in password_hash and
