...
export async function POST(req: NextRequest) {
  ...
  // Same session check as /api/orders — customer ordering requires a logged-in
  // session and the order must belong to that customer. Rejects the "guest"
  // and "pos-walk-in" sentinels (neither can equal a real session id); there
  // is no anonymous card checkout.
