        ...
        {step === "cash" && (
          <div className="p-5">
            ...
            <button
              ...
              className={`w-full py-3.5 rounded-xl font-bold text-sm transition-all ${cashTendered >= due ? "bg-green-500 hover:bg-green-400 text-white active:scale-[0.98]" : "bg-slate-700 text-slate-500 cursor-not-allowed"}`}
            >
        ...
        {step === "card" && (
          <div className="p-5">
            ...
            <div className="text-center py-6">
              ...
              <p className="text-2xl font-bold text-blue-400 mt-4">{fmt(due, currencySymbol)}</p>
            </div>
            <button
