...
export default function SiteMobileHeader() {
  ...
  const coreNavItems = [
    ...
    { label: "Orders", Icon: Receipt,          href: "/account" },
    ...(reservationsEnabled ? [{ label: "Book", Icon: CalendarDays, href: "/book" }] : []),
  ];
  ...
  return (
    <>
      ...
      {drawerOpen && (
        <div
          className="lg:hidden fixed inset-0 bg-black/30 z-40 backdrop-blur-[1px]"
          onClick={close}
        />
      )}
